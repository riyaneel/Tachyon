...
export const tachyon_browser_echo_once: (a: number, b: number) => [number, number, number];
...
export const wasmbus_recvU32: (a: number) => [number, number, number];
...
export const wasmbus_sendU32: (a: number, b: number, c: number) => [number, number];
export const wasmbus_sendU32Unflushed: (a: number, b: number, c: number) => [number, number];
